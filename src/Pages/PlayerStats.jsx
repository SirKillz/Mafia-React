...
function PlayerStats() {
    ...
    // Load the average game stats on mount
    useEffect(() => {
        ...
        <div className="player-stats">
            ...
            <div className="average-stats">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>{averageStats.avg_spy_check_rate * 100}%</td>
                            <td>{averageStats.avg_medic_self_save_rate * 100}%</td>
                            <td>{averageStats.avg_successful_medic_save_rate * 100}%</td>
                            <td>{averageStats.avg_successful_assassin_shot_rate * 100}%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
